...
export default function SignupPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        const { success } = await signup(form.name, form.email, form.password, form.firm)
            ...
            <div className="flex-1 flex items-center justify-center p-8 lg:p-24 bg-gray-50/50">
                ...
                >
                    <div className="text-center lg:text-left mb-10">
                        <h3 className="text-3xl font-black text-gray-900 mb-2 tracking-tight">Create Firm Account</h3>
                        <p className="text-gray-500 font-medium">Start your 14-day premium Pro trial today.</p>
                    </div>
                    ...
                    <div className="bg-white rounded-[2.5rem] shadow-2xl shadow-gray-200/50 p-10 border border-gray-100 relative">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            >
                                {isLoading ? 'Building Workspace...' : 'Register Firm Account'}
                            </button>
                        </form>
                    </div>

                    <p className="mt-8 text-center text-sm font-medium text-gray-500">
                        Already have an account? <Link to="/login" className="text-primary-600 font-black hover:underline underline-offset-4">Sign In</Link>
                    </p>
                </motion.div>
            </div>
        </div>
